...
<body class="flex flex-col h-screen justify-between xl:overflow-hidden lg:overflow-hidden md:overflow-hidden overflow-auto font-mono">
    ...
    <section class="text-gray-600 body-font text-center">
        ...
        <div class="container mx-auto p-2 text-center">
            <div class="inline-flex order-first lg:order-none lg:w-3/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
            ...
            <a type="button" class="xl:absolute xl:right-10 xl:bottom-20 lg:absolute lg:right-10 lg:bottom-20 md:absolute md:right-10 md:bottom-20 inline-flex text-black items-center bg-green-400 border-2 border-green-900 py-2 px-3 focus:outline-none hover:bg-green-600 rounded text-lg mt-4 md:mt-0" href="paper.php">Add Paper
