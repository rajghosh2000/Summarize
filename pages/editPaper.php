...
<body class="flex flex-col h-screen justify-between overflow-hidden">
    ...
    <section class="text-gray-600 body-font font-mono relative overflow-auto">
        <div class="flex flex-col text-center w-full mb-2">
            <h2 class="text-xs text-green-500 tracking-widest font-semibold title-font">EDIT SUMMARY PAGE</h2>
        </div>
        <form class="container px-5 py-2 mx-auto" method="post" action="../php-src/modifyPaper.php?sno=<?php echo $paperID; ?>&method=edit">
            <div class="w-full border-2 border-green-300 rounded-lg static sm:mr-10 p-5 flex flex-col justify-start relative bg-gray-200 p-10 flex flex-row">
            ...
            <div class="bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                ...
                <div class="p-2 w-full">
                    ...
                    <div id="editor" class="h-96 overflow-y-auto w-full bg-white rounded border border-gray-300 lg:h-52 h-40 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">
                        <?php echo $row['paper_user_summary'] ?>
                    </div>
